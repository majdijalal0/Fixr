...
const JoinAsPro = () => {
  ...
  return (
    <section id='joinaspro' className="py-20 bg-slate-900 rounded-[3rem] mx-4 my-20 overflow-hidden relative scroll-mt-24">
      <AnimatePresence>
        {warningType && (
          <motion.div
            ...
            className="fixed top-24 left-1/2 -translate-x-1/2 z-[200] w-[90%] max-w-md bg-slate-950/90 border border-white/10 backdrop-blur-md px-6 py-4 rounded-2xl shadow-2xl shadow-amber-500/5 flex items-center justify-between gap-4"
          >
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"
      >
        <div className="relative z-10">
          ...
          <Link 
            ...
            className="px-10 py-4 bg-amber-500 hover:bg-amber-600 text-slate-900 font-black rounded-2xl transition-all shadow-xl shadow-amber-500/20 active:scale-95 inline-block"
          >
            Apply to be a Pro
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
          <div className="p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl flex flex-col justify-between">
            <div>
              <ShieldCheck className="text-amber-500 mb-4" size={32} />
              <h3 className="text-white font-bold text-xl mb-2">Verified Trust</h3>
          ...
          <div className="p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-white font-bold text-xl mb-2">Grow Fast</h3>
