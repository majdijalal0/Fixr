...
const CardLayout = ({ selectedServiceId }) => {
  ...
  if (isLoading) {
    return (
      <div className='flex-1 p-4 md:p-10 flex justify-center items-center h-full'>
  ...
  return (
    <div className='flex-1 p-4 md:p-10'>
      ...
      {sortedWorkers.length > 0 ? (
        ...
        <div className='flex flex-col items-center justify-center py-16 md:py-20 bg-zinc-50 rounded-3xl border-2 border-dashed border-zinc-200'>
          <p className='text-lg md:text-xl text-zinc-400 font-medium'>No professionals found in this category yet.</p>
          <button 
